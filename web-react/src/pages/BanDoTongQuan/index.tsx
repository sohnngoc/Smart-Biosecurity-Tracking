      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 bg-white/50 dark:bg-slate-800/50 px-3 py-2 rounded-xl shadow-sm border border-slate-200/50 dark:border-slate-700/50">
            <div className="w-8 h-8 rounded-lg bg-linear-to-br from-emerald-500 to-emerald-700 items-center justify-center shadow-lg shadow-emerald-500/20 hidden sm:flex">
              <MapIcon className="w-5 h-5 text-white" />
            </div>
            <div className="w-8 h-8 rounded-lg bg-linear-to-br from-emerald-400 to-cyan-500 flex items-center justify-center shadow-lg shadow-emerald-500/20 sm:hidden">
